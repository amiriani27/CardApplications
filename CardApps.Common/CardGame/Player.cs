...
namespace CardApps.Common
{
    public class Player
    {
        ...
        private bool _goingAlone;
        private bool _cardPlayed;
        private PlayerDecision _playerDecision = PlayerDecision.NoDecision;

        private TrumpSuit _trumpSuit;
        ...
        public bool IsDealer { get { return _isDealer; } set { _isDealer = value; } }
        public bool GoingAlone { get { return _goingAlone;} set { _goingAlone = value; } }
        public PlayerDecision GetPlayerDecision { get { return _playerDecision; } set { _playerDecision = value; } }
        public bool CardPlayed { get { return _cardPlayed; } set { _cardPlayed = value;  } }
        public TrumpSuit SuitSelected { get { return _trumpSuit; } set { _trumpSuit = value; } }

        public override string ToString()
        {
            string ovrdString = string.Empty;
            List<Card> sortedList = Hand.Cards.OrderBy(o => o.FaceVal).ToList();

            foreach (Card sCard in sortedList)
            {
                ovrdString += string.Concat(sCard.FaceVal.ToString(), " of ", sCard.Suit.ToString(), "\n");
            }
        ...
        {
            _playerDecision = PlayerDecision.NoDecision;
            _cardPlayed = false;
            _goingAlone = false;
            _isDealer = false;
        }
